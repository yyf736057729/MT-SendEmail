...
public class SendmailUtil {
    ...
    public static String myEmailAccount = "yyf736057729@qq.com";
    public static String myEmailPassword = "tomryltkwqvmbgaf";//这个密码不是QQ密码或者邮箱密码，要验证的。自己百度
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "626477063@qq.com";
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail) throws Exception {
        ...
        DataHandler dh = new DataHandler(new FileDataSource("C:\\Users\\yy\\Desktop\\img\\f987c6c434dc67148ed8cf7318b4d62.jpg")); // 读取本地文件
        ...
        DataHandler dh2 = new DataHandler(new FileDataSource("C:\\Users\\yy\\Desktop\\img\\cc.txt"));  // 读取本地文件
