...
public class JavaMailSend {
    ...
    public static void main(String[] args) {
        sendMail("626477063@qq.com","101.37.117.13服务器炸啦！","BOOM!");
    }

    public static boolean sendMail(String emailTo,String content,String subject) {

        String fromEmail="yyf736057729@qq.com";//你的QQ邮箱
        String eMailType="smtp.qq.com";
        String eMailAuthPassword="tomryltkwqvmbgaf";//QQ邮箱授权码 开通POP3/SMTP服务 的授权码
